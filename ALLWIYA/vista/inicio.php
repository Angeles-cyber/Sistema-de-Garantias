...
<head>
    <meta charset="UTF-8">
    <title>Bienvenido a ALLWIYA</title>
...
<body class="fondo">
    <div class="container presentacion">
        <h1>Bienvenido al Centro de Garantías <span style="color:#ff8800;">ALLWIYA S.A.C</span></h1>
        <p>
            En <strong>ALLWIYA</strong>, nos especializamos en la venta y ensamblaje <strong>personalizado de computadoras</strong>, ofreciendo soluciones tecnológicas a la medida de cada cliente. Ya sea que necesites una máquina para trabajar, estudiar o jugar, cada equipo ha sido <strong>cuidadosamente ensamblado</strong> y probado para garantizar el mejor rendimiento.
        </p>
        <p>
        ...
        <div class="acciones-principales">
            <a href="indexall.php?accion=crear" class="btn crear">+ Crear Garantía</a>
            <a href="indexall.php?accion=listar" class="btn ver">📋 Ver Garantías</a>
        </div>
