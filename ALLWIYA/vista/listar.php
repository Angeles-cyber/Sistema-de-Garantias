        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="acciones">
                            <a class="btn editar" href="indexall.php?accion=editar&id=<?= $g['id'] ?>">Editar</a>
                            <a class="btn eliminar" href="indexall.php?accion=eliminar&id=<?= $g['id'] ?>" onclick="return confirm('¿Seguro que deseas eliminar esta garantía?')">Eliminar</a>
                        </div>
                    </td>
                </tr>
                <?php endforeach ?>
