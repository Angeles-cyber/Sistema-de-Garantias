...
<head>
    <meta charset="UTF-8">
    <title>Bienvenido a RIOS TEVES</title>
...
<body class="fondo">
    <div class="container presentacion">
        <h1>Bienvenido al Centro de Garantías <span style="color:#1e90ff;">RIOS TEVES E.I.R.L</span></h1>
        <p>
            En <strong>RIOS TEVES</strong>, nos especializamos en la gestion de proyectos <strong>personalizado de computadoras</strong>, ofreciendo soluciones tecnológicas a la medida de cada cliente. Ya sea que necesites una máquina para trabajar, estudiar o jugar, cada equipo ha sido <strong>cuidadosamente ensamblado</strong> y probado para garantizar el mejor rendimiento.
        </p>
        <p>
        ...
        <div class="acciones-principales">
            <a href="indexrios.php?accion=crear" class="btn crear">+ Crear Garantía</a>
            <a href="indexrios.php?accion=listar" class="btn ver">📋 Ver Garantías</a>
        </div>
